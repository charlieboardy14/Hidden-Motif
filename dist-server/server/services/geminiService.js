...
exports.evaluateArtworks = exports.generateImage = exports.generateArtistPrompt = exports.generateDodgerPrompt = exports.generateRoundData = void 0;
            ...
            const response = await ai.models.generateContent({
                ...
                config: {
                    ...
                    responseSchema: {
                        ...
                        properties: {
                            theme: { type: genai_1.Type.STRING, description: "The creative theme for the round." },
                            motif1: { type: genai_1.Type.STRING, description: "The first secret noun motif." },
                            motif2: { type: genai_1.Type.STRING, description: "The second secret noun motif." },
                        },
...
exports.generateRoundData = generateRoundData;
const generateDodgerPrompt = async (theme, motif1, motif2) => {
    try {
        return await withRetry(async () => {
...
exports.generateDodgerPrompt = generateDodgerPrompt;
const generateArtistPrompt = async (theme, motif1, motif2) => {
    try {
        return await withRetry(async () => {
...
exports.generateArtistPrompt = generateArtistPrompt;
...
const evaluateArtworks = async (artworks, theme) => {
    try {
        return await withRetry(async () => {
...
exports.evaluateArtworks = evaluateArtworks;
